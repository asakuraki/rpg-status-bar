                ...
                if (section === "<TopBar>") {
                    ...
                    if (currentSection === "topBar") {
                        ...
                        for (const line of lines) {
                            ...
                            if (key === "CUR") {
                                if (values.length >= 1) {
                                    result.player.currency = parseInt(values[0]);
                                    if (values.length >= 2 && values[1]) {
                                        result.player.currencyName = cleanString(values[1]);
                                    }
                                }
                            }
                    ...
                    <div class="rpg-tab-content">
                        ...
                        <div id="rpg-status-pane" class="rpg-tab-pane active">
                            <div class="rpg-status-header">
                                ...
                                ${typeof gameData.player.currency !== 'undefined' ? 
                                `<div class="rpg-currency-display">
                                    <i class="fas fa-coins"></i> ${gameData.player.currency} ${gameData.player.currencyName}
                                </div>` : ''}
                            </div>
